...
type
  HModule = RayLib.Core.HModule;

const
  ModuleNil = RayLib.Core.ModuleNil;
  SharedSuffix = RayLib.Core.SharedSuffix;
  HiByte = High(Byte);
...
function LibraryLoad(const Name: string): HModule;
begin
  Result := RayLib.Core.LibraryLoad(Name);
end;

function LibraryUnload(Module: HModule): Boolean;
begin
  Result := RayLib.Core.LibraryUnload(Module);
end;

function LibraryGetProc(Module: HModule; const ProcName: string): Pointer;
begin
  Result := RayLib.Core.LibraryGetProc(Module, ProcName);
end;
